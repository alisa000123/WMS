...
class Warehouse:
    def __init__(self, ads_client):
        ...
        self.fifo_queue = deque() # FIFO queue of coordinates
    ...
    def add_block(self):
        ...
        for pos in self.positions:
            if not self.occupied[pos]:
                ...
                self.fifo_queue.append(pos)# Add to end of FIFO
    ...
    def remove_block(self):
        ...
        pos = self.fifo_queue.popleft()# Take oldest position from FIFO
